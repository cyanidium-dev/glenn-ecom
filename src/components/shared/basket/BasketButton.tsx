...
export default function BasketButton() {
  ...
  return (
    <button
      className="relative size-[25px] lg:size-[35px] outline-none ml-auto mb-[10px] cursor-pointer transition-opacity duration-300 ease-in-out md:hover:opacity-70 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-white"
