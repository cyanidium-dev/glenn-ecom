  ...
  return (
    <div className="relative">
      ...
      <button
        ...
        onClick={goPrev}
        className="absolute -left-[10px] lg:-left-[61px] z-10 transition-all duration-300 cursor-pointer outline-none focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-white"
      ...
      <button
        ...
        onClick={goNext}
        className="absolute -right-[10px] lg:-right-[61px] z-10 transition-all duration-300 cursor-pointer outline-none focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-white"
        style={{ top: arrowTopPosition, transform: "translateY(-50%)" }}
