export default function PageDecorations() {
  return (
    <div className="absolute inset-0 pointer-events-none">
       ...
       */}
      <div
        className="absolute -z-30 top-[-24%] bottom-[26%] lg:top-[-60%] lg:bottom-[-30%] left-1/2 -translate-x-1/2 w-full"
        style={{
          background:
      ...
      />
      <div
        className="absolute -z-40 top-[-24%] bottom-[26%] lg:top-[-60%] lg:bottom-[-30%] left-1/2 -translate-x-1/2 w-full"
        style={{
          background:
      ...
      />
      <div
        className="absolute -z-30 top-[73%] bottom-[-42%] lg:top-[129%] lg:bottom-[-177%] left-1/2 -translate-x-1/2 w-full"
        style={{
          background:
